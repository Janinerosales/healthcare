        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <input type="number" value="{{$profiles->phone_number}}" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" id="exampleInputAddress" required>
              @error('phone_number')
